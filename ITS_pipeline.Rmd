...
```{r}
notified_reads_to_seqtable_ITS <- run_with_notification(fun = reads_to_seqtable_ITS, 
...
```{r}
notified_assemble_phyloseq_ITS <- run_with_notification(fun = assemble_phyloseq_ITS, 
